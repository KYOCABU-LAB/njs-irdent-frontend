...
export function TabsCrearPacientes() {
  const pathname = usePathname();

  const tabs = [
    {
      name: "Datos de Identificación",
      href: `/pacientes/crear/datos-identificacion`,
      icon: BookUser,
    },
    {
      name: "Contacto",
      href: `/pacientes/crear/contacto`,
      icon: UserRoundSearch,
    },
    {
      name: "Dirección",
      href: `/pacientes/crear/direccion`,
      icon: MapPinHouse,
    },
    {
      name: "Facturación",
      href: `/pacientes/crear/facturacion`,
      icon: ReceiptText,
    },
  ];
